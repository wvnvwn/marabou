...
### Q: "Marabou not installed" warning
...
### Q: "Model not found" error during verification
...
| External modules listed | ✅ | Section 2.2 |
| Environment documented | ✅ | Section 2 |
| Code comments | ✅ | All Python files |
| Single execution test | ✅ | `bash run_all.sh` |
| Model selection documented | ✅ | Section 3 |
| Dataset selection documented | ✅ | Section 3 |
| Marabou integration | ✅ | verify_model.py |
| Written in English | ✅ | All files |

### Assignment 3 Specific Requirements

1. **Explore Marabou Resources** ✅
   - Reviewed [Marabou GitHub resources](https://github.com/NeuralNetworkVerification/Marabou/tree/master/resources)
   - Selected model and dataset NOT in resources directory

2. **External Model and Dataset** ✅
   - Model: SmallCNN (custom, ~50K parameters)
   - Dataset: CIFAR-10 (not in Marabou resources)
   - Appropriately sized for Marabou verification

3. **Documentation** ✅
   - Model/dataset selection rationale (Section 3)
   - Preprocessing steps (automatic normalization)
   - Marabou execution steps (Section 5)
